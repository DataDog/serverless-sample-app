...
public class InventoryAclServiceStack : Stack
{
    internal InventoryAclServiceStack(Construct scope, string id, IStackProps props = null) : base(scope, id, props)
    {
        ...
        var api = new InventoryAclService(this, "DotnetInventoryAcl", new InventoryAclServiceProps(sharedProps, secret, eventBus));
    }
}