...
public class ProductApiContainerStack extends Stack {
    public ProductApiContainerStack(final Construct scope, final String id) {
        this(scope, id, null);
    }

    public ProductApiContainerStack(final Construct scope, final String id, final StackProps props) {
        ...
        var api = new ProductApiContainer(this, "JavaProductApiContainer", new ProductApiContainerProps(sharedProps));
    }
}
