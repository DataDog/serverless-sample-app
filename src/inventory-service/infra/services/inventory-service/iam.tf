...
resource "aws_iam_policy" "function_logging_policy" {
  name = "InventoryOrdering-logging-policy-${var.env}"
  policy = jsonencode({
    "Version" : "2012-10-17",
    "Statement" : [
      {
