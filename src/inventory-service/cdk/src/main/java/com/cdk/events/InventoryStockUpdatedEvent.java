...
public class InventoryStockUpdatedEvent extends Rule {
    public InventoryStockUpdatedEvent(@NotNull Construct scope, @NotNull String id, @NotNull SharedProps sharedProps, @NotNull IEventBus inventoryServiceEventBus) {
