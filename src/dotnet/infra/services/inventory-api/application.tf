...
resource "aws_iam_role" "ecs_task_execution_role" {
  name = "DotnetInventoryApiTaskExecutionRole"
...
resource "aws_iam_role" "ecs_task_role" {
  name = "DotnetInventoryApiTaskRole"
...
module "inventory_api_web_service" {
  ...
  service_name = "DotnetInventoryApi"
  ...
  environment_variables = [
    {
      name  = "TABLE_NAME"
      value = aws_dynamodb_table.dotnet_inventory_api.name
    },
    {
      name  = "EVENT_BUS_NAME"
