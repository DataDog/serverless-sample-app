...
type AnalyticsServiceStackProps struct {
	awscdk.StackProps
}

func NewAnalyticsServiceStack(scope constructs.Construct, id string, props *AnalyticsServiceStackProps) awscdk.Stack {
	...
	NewAnalyticsService(stack, "InventoryOrderingService", &AnalyticsServiceProps{
