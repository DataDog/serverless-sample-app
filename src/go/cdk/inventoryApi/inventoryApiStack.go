...
type InventoryApiStackProps struct {
	awscdk.StackProps
}

func NewInventoryApiStack(scope constructs.Construct, id string, props *InventoryApiStackProps) awscdk.Stack {
	...
	NewInventoryApi(stack, "InventoryApi", &InventoryApiProps{
