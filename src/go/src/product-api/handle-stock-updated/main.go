...
type LambdaHandler struct {
	commandHandler core.ProductStockUpdatedEventHandler
}

func NewLambdaHandler(commandHandler core.ProductStockUpdatedEventHandler) *LambdaHandler {
...
func main() {
	...
	handler := NewLambdaHandler(*core.NewProductStockUpdatedEventHandler(adapters.NewDynamoDbProductRepository(*dynamoDbClient, tableName)))
