...
require github.com/aws/aws-sdk-go-v2 v1.36.1 // indirect

require github.com/aws/aws-sdk-go-v2/service/eventbridge v1.36.11

require github.com/aws/aws-sdk-go-v2/service/dynamodb v1.40.1 // indirect
