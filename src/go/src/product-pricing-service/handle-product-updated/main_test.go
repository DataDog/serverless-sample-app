...
func Test_WhenEventPayloadIsValid_ShouldGeneratePricing(t *testing.T) {
	...
	eventHandler := core.NewProductUpdatedEventHandler(spyEventPublisher, core.PricingService{})
	...
	snsEvent.Records = append(snsEvent.Records, events.SNSEventRecord{
		SNS: events.SNSEntity{
			Message: "{\"data\":{\"productId\":\"61b1258e-9952-43e0-b6c0-8e9ecb300c7e\", \"new\": {\"price\": 12.99}},\"_datadog\":{\"traceparent\":\"00-66fa8967000000006db552623d83a6f7-6db552623d83a6f7-01\",\"tracestate\":\"dd=s:1;p:6db552623d83a6f7;t.dm:-1;t.tid:66fa896700000000\",\"x-datadog-parent-id\":\"7905315302811084535\",\"x-datadog-sampling-priority\":\"1\",\"x-datadog-tags\":\"_dd.p.tid=66fa896700000000,_dd.p.dm=-1\",\"x-datadog-trace-id\":\"7905315302811084535\"}}",
		},
	})
...
func Test_WhenEventPayloadIsMissingProductId_ShouldNotPublishEvent(t *testing.T) {
	...
	snsEvent.Records = append(snsEvent.Records, events.SNSEventRecord{
		SNS: events.SNSEntity{
			Message: "{\"data\":{\"productId\":\"\", \"new\": {\"price\": 12.99}},\"_datadog\":{\"traceparent\":\"00-66fa8967000000006db552623d83a6f7-6db552623d83a6f7-01\",\"tracestate\":\"dd=s:1;p:6db552623d83a6f7;t.dm:-1;t.tid:66fa896700000000\",\"x-datadog-parent-id\":\"7905315302811084535\",\"x-datadog-sampling-priority\":\"1\",\"x-datadog-tags\":\"_dd.p.tid=66fa896700000000,_dd.p.dm=-1\",\"x-datadog-trace-id\":\"7905315302811084535\"}}",
		},
	})
