...
module "inventory_acl_function" {
  service_name   = "GoInventoryAcl"
  source         = "../../modules/lambda-function"
  entry_point = "../src/inventory-acl/product-created-public-event-handler"
  function_name  = "GoInventoryAcl"
  lambda_handler = "index.handler"
  environment_variables = {
    PRODUCT_ADDED_TOPIC_ARN : aws_sns_topic.go_inventory_new_product_added.arn
