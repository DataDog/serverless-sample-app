...
module "inventory_ordering_service" {
  service_name   = "GoInventoryOrderingService"
  source         = "../../modules/lambda-function"
  entry_point = "../src/inventory-ordering-service/handle-product-added"
  function_name  = "GoInventoryOrderingService"
...
resource "aws_sfn_state_machine" "inventory_ordering_state_machine" {
  ...
  definition = templatefile("${path.module}/../../../cdk/inventory-ordering-service/workflows/ordering-workflow-setStock.asl.json", {
...
resource "aws_ssm_parameter" "api_endpoint" {
  name  = "/go/${var.env}/inventory-ordering/state-machine-arn"
  type  = "String"
