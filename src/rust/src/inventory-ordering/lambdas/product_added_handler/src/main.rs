...
use inventory_ordering_core::{adapters::StepFunctionsWorkflow, core::OrderingWorkflow, ports::handle_product_added_event};
...
async fn main() -> Result<(), Error> {
    ...
    let workflow_arn = std::env::var("ORDERING_SERVICE_WORKFLOW_ARN").expect("ORDERING_SERVICE_WORKFLOW_ARN is not set");
